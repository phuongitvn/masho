...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
<tr>
{{*<td width="50" align="center"><img src="thumbnail:show?user_id={{$item.friendid}}&size=large&adjust_vga=on"></td>*}}
<td width="60" align="center"><img src="http://{{$app.domain.img}}/card/{{$item.prof}}_s.jpg" alt="" width="60" /></td>
<td><span style="font-size:x-small;"><a href="{{"/other/?id="|cat:$item.friendid|cnvgw}}"> Quân đoàn {{$item.handle}}</a><br />
...
{{include file="parts/pager.tpl" url="/my/greet/list/"}}
</div>
