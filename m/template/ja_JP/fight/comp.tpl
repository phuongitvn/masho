...
<div style="text-align:center; background-color:#820000; color:#ffffff;">Tìm kiếm đối thủ chiến đấu lần nưã</div>
...
Đối thủ không thể lấy được báu vật đã thành gói </span></td></tr>
</table>
</div>
<div style="background-color:#ffffff;"><img src="http://{{$app.domain.img}}/spacer.gif" width="1" height="1" /></div>
...
{{/if}}
{{include file="parts/emoji.tpl" id=26}}Tìm đấu</a></div>
